...
#[derive(Clone, Copy)]
struct SwedbankTest;
impl ConnectorActions for SwedbankTest {}
impl utils::Connector for SwedbankTest {
    fn get_data(&self) -> types::api::ConnectorData {
        use router::connector::Swedbank;
        types::api::ConnectorData {
            connector: Box::new(&Swedbank),
            connector_name: types::Connector::Swedbank,
...
static CONNECTOR: SwedbankTest = SwedbankTest {};
